class Boss extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('tilesB', './assets/tilesheetBoss.png');
        this.load.tilemapTiledJSON('mapB', './assets/worldBoss.json');
    }
    ...
    create() {
        ...
        const tileSet = map.addTilesetImage('tile_sheet_boss', 'tilesB');
        ...
        const platforms2 = map.createLayer('Platforms2', tileSet, 0, 96);
        ...
        this.cam.setBackgroundColor('#00796b');
